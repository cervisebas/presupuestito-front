...
export class Invoice {
  ...
  public getInvoices() {
    return this.http.get<InvoiceResponse[]>(Endpoints.INVOICES);
  }
  ...
  public createInvoice(data: InvoiceRequest) {
    return this.http.post<void>(Endpoints.INVOICES, data);
  }

  public updateInvoice(data: InvoiceRequest) {
    return this.http.put<void>(Endpoints.INVOICES, data);
  }
