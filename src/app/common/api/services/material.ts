...
export class Material {
  ...
  public getMaterials() {
    return this.http.get<MaterialResponse[]>(Endpoints.MATERIALS);
  }
  ...
  public createMaterial(data: MaterialRequest) {
    return this.http.post<void>(Endpoints.MATERIALS, data);
  }
  ...
  public deleteMaterial(id_material: number) {
    return this.http.delete<void>(`${Endpoints.MATERIALS}/${id_material}`);
  }
}
