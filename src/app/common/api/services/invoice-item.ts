...
export class InvoiceItem {
  ...
  public getInvoiceItems() {
    return this.http.get<InvoiceItemResponse[]>(Endpoints.INVOICE_ITEM);
  }
  ...
  public createInvoiceItem(data: InvoiceItemRequest) {
    return this.http.post<void>(Endpoints.INVOICE_ITEM, data);
  }

  public updateInvoiceItem(data: InvoiceItemRequest) {
    return this.http.put<void>(Endpoints.INVOICE_ITEM, data);
  }
